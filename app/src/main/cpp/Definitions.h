//
// Created by Michael Edwards on 11/6/2019.
// Frequently used values for audio playback and analysis.
//

#ifndef SIMPLE_TUNER_DEFINITIONS_H
#define SIMPLE_TUNER_DEFINITIONS_H
